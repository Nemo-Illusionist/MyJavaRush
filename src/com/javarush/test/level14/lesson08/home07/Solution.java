...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (Apartament lol :
                apartaments)
        {
            if (lol instanceof Apt1Room)
                ((Apt1Room) lol).clean1Room();
            else if (lol instanceof Apt2Room)
                ((Apt2Room) lol).clean2Rooms();
            else if (lol instanceof Apt3Room)
                ((Apt3Room) lol).clean3Rooms();
        }
    }
